<div>
    ...
    <div class="w-full h-full min-h-[80vh] flex flex-col items-center justify-center" x-data="">
        ...
        <div class="w-11/12 px-6 py-4 md:m-auto bg-white shadow-md overflow-hidden rounded-lg">
            ...
            <form enctype="multipart/form-data" wire:submit.prevent="update" class="update-bird-form flex flex-col items-center">
                ...
                <div class="flex flex-wrap justify-center md:justify-start">
                    ...
                    <div class="form-section flex flex-col min-w-[15em] w-[45%] m-2">
                        ...
                        @else
                            @if ($bird->image)
                                <img src="{{ asset('storage/'.$bird->image) }}" class="w-[15em] m-auto"> 
                            @endif
                        @endif
                    </div>
                ...
                <button type="submit" class="mx-auto mb-6 mt-12 block bg-indigo-700 hover:bg-indigo-900 rounded-md font-semibold px-6 py-1 text-white text-md">Update Bird</button>
