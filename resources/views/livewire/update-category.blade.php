...
<div class="w-full h-full min-h-[80vh] flex flex-col items-center justify-start" x-data="">
    ...
    <div class="w-11/12 px-6 py-4 bg-white shadow-md overflow-hidden rounded-lg">
        ...
        <form wire:submit.prevent="update" class="update-category-form flex flex-col items-center">
            ...
            <button type="submit" class="mx-auto mb-6 mt-12 block bg-indigo-700 hover:bg-indigo-900 rounded-md font-semibold px-6 py-1 text-white text-md">update Category</button>
